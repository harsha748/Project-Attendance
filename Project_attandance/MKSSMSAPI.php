...
$json = json_decode(file_get_contents("https://smsapi.engineeringtgr.com/send/?Mobile=7014267935&Password=varun123&Message=".urlencode($message)."&To=".urlencode($mobile)."&Key=varunftzdW2IsuQ4aBHcKjCZ"),true);
